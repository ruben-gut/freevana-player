package freevana.util
{
    ...
    public class FreevanaDB
    {
        ...
        {
            var moviesQuery:String = "SELECT m.*, src.url FROM movies m INNER JOIN movie_sources src " +
        ...
        public function getEpisodes(seasonId:int):Array
        {
            ...
            var episodesQuery:String = "SELECT e.*, (e.number || ') ' || e.short_name) as name, src.url " +
